...
INSERT INTO `AnnualData` VALUES (10,'tardes','','Plaza Cubela','SUBSIDIO_RETORNADO','2023-07-11','2023-06-07','2023-06-01','fontaneria',_binary '\0','marta','NO',_binary '','sergas',6,5,_binary '\0','15008','ninguna','ninguna','ninguna',_binary '',_binary '',_binary '','REGULAR','ninguna','xunta',_binary '',_binary '',_binary '\0',2,2,6,1,1,14,1,8,1,'SI'),(11,'tardes','','Plaza Cubela','SUBSIDIO_RETORNADO','2023-07-11','2023-06-07','2023-06-01','fontaneria',_binary '\0','marta','NO',_binary '','sergas',6,5,_binary '\0','15008','ninguna','ninguna','ninguna',_binary '',_binary '',_binary '','REGULAR','ninguna','xunta',_binary '',_binary '',_binary '\0',2,2,6,1,1,15,1,8,1,'SI'),(12,'mañanas','','Plaza Cubela','SUBSIDIO_RETORNADO','2022-06-17','2023-06-07','2023-06-01','fontaneria',_binary '\0','marta','NO',_binary '','sergas',6,5,_binary '\0','15008','ninguna','ninguna','ninguna',_binary '',_binary '',_binary '','REGULAR','ninguna','xunta',_binary '',_binary '',_binary '\0',2,2,6,1,1,15,1,8,1,'SI'),(13,'tardes','','Calle san diego','SUBSIDIO_RETORNADO','2023-06-23','2023-06-15','2023-06-08','fontaneria',_binary '\0','ayutamiento','LESS_33',_binary '','sergas',3,2,_binary '','14002','España','ninguna','ninguna',_binary '',_binary '',_binary '','REGULAR','ninguna','xunta',_binary '',_binary '',_binary '',3,2,4,1,30,16,1,7,5,'SI');
...
INSERT INTO `Kid` VALUES (31,'2023-06-17','H',16),(32,'2023-06-15','H',16),(33,'2023-07-13','H',15);
...
INSERT INTO `Observation` VALUES (1,'2020-06-26','cosas','Primera observación revisada',14),(3,'2020-04-26','cosas avanzadas','Primera revision',14),(4,'2020-01-26','cosas avanzadas 2','Segunda revision',14);
...
INSERT INTO `Participant` VALUES (14,'2023-06-02','2023-06-20','54153223E','crespo.rozados@gmail.com','H','2023-06-14','Miguel','','','684350303','Crespo Rozados',3),(15,'2004-02-23','2023-06-20','54153224T','crespo.rozados@gmail.com','H','2023-06-14','Oscar','','','684350303','Crespo Rozados',3),(16,'1990-10-10','2023-06-08','44811925J','asd@saa.com','M',NULL,'Fernando','','','345023443, 342344234','Ferreiro Crespo',64);
...
INSERT INTO `Participant_yearList` VALUES (14,2023),(15,2022),(15,2023),(16,2023);
...
CREATE TABLE `WorkInsertion` (
  ...
  `participant_id` bigint DEFAULT NULL,
  `workField_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK49fq1bh4qxjp6qaty6vs97kv3` (`participant_id`),
  KEY `FKb3v45scd1k0q8uf5dwanlq1it` (`workField_id`),
  CONSTRAINT `FK49fq1bh4qxjp6qaty6vs97kv3` FOREIGN KEY (`participant_id`) REFERENCES `Participant` (`id`),
  CONSTRAINT `FKb3v45scd1k0q8uf5dwanlq1it` FOREIGN KEY (`workField_id`) REFERENCES `WorkField` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `WorkInsertion` WRITE;
...
INSERT INTO `participant_countrie` VALUES (11,3),(12,4),(11,5),(12,6),(13,7),(10,8),(13,17);
...
INSERT INTO `participant_exclusionFactor` VALUES (12,1),(10,4),(11,4),(13,5),(13,6);
...
INSERT INTO `participant_language` VALUES (11,2),(10,3),(12,4),(13,4),(11,5),(12,7);
...
CREATE TABLE `participant_program` (
  ...
  CONSTRAINT `FK3o570j9xkkgdu9mrlisotsyc4` FOREIGN KEY (`exclusionFactor_id`) REFERENCES `ExclusionFactor` (`id`),
...
INSERT INTO `participant_program` VALUES (1,_binary '',10,2),(2,_binary '\0',10,3),(5,_binary '',11,3),(6,_binary '',11,3);
...
-- Dump completed on 2023-07-13 23:24:45
